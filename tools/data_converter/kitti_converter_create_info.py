...
def get_kitti_info_path(idx,
    ...
    if training:
        ...
        print('total_path',str(pre_prefix / prefix / file_path))
    ...
    if relative_path:
        ...
        # return str(pre_prefix / prefix / file_path)
        # print('total_path',str(pre_prefix / prefix / file_path))
...
def create_kitti_info_file(data_path,
    ...
    test_img_ids = _read_imageset_file(str(imageset_folder / 'test_saic.txt'))
...
if __name__ == '__main__':
    data_path = './data/saic_16line_bin/'
    pkl_prefix = 'kitti_saic'
    create_kitti_info_file(data_path,pkl_prefix,with_plane=False,save_path=None,relative_path=True)
    # def create_kitti_info_file(data_path,
    #                        pkl_prefix='kitti',
    #                        with_plane=False,
    #                        save_path=None,
